...
# --- POCZĄTEK SEKCJI FILTROWANIA ---
view_mode = st.sidebar.selectbox("Wybierz tryb wyświetlania sekcji", [
    "Wszystkie sekcje",
    "Sekcje 1 - 7",
    "Sekcje 8 - 14",
    "Sekcje 15 - 21",
...
def show_sec(num):
    if view_mode == "Wszystkie sekcje": return True
    if view_mode == "Sekcje 1 - 7" and 1 <= num <= 7: return True
    if view_mode == "Sekcje 8 - 14" and 8 <= num <= 14: return True
    if view_mode == "Sekcje 15 - 21" and 15 <= num <= 21: return True
    if view_mode == "Sekcje 22 - 28" and 22 <= num <= 28: return True
    if view_mode == "Sekcje 29 - 35" and 29 <= num <= 35: return True
    return False
